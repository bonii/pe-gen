...
extern "C"
{
	...
	unsigned int _line_, const char **_sfunc_, const char **_sfile_,
	unsigned int * _slevel_, char ***);
    extern void _db_return_(unsigned int _line_, const char **_sfunc_,
	const char **_sfile_, unsigned int * _slevel_);
...
#define DBUG_ENTER(a) const char *_db_func_, *_db_file_; unsigned int _db_level_; \
	char **_db_framep_; \
