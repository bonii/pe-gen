%{
/*
    fcl.y is part of FCL_INT
    fcl.y - Grammar file for FCL interpreter.
...
%token _READ _GOTO _IF _THEN _ELSE _RETURN _ID _NUMBER _ASSIGN _EQ _ADD _MINUS
       _MUL _DIV _LT _LTE _GT _GTE _ARROW
...
program: _READ vars _ARROW _ID basicblocks      { prog = mkprogram($4, $5); args = $2; }
       | _READ _ARROW _ID basicblocks           { prog = mkprogram($3, $4); args = NULL; }
